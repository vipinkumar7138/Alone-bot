...
exec("rm -rf modules/commands/data && mkdir -p modules/commands/data && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("JULMI JAAT ❯ ") + chalk.hex("#00ffff")("fixed by JULMI JAAT"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ JULMI JAAT (JULMI) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`JULMI`, '[ JULMI (JAAT) ]');
        logger('Hey, thank you for using this Bot', '[ JULMI (JAAT) ]');
        logger("Fixed by Julmi", '[ JULMI (JAAT) ]');
