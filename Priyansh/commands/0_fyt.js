module.exports.config = {
  ...
  hasPermssion: 2,
  credits: "satish",
  description: "auto send massage",
  commandCategory: "Fight",
  usages: "fyt",
  cooldowns: 7,
  dependencies: {
      "fs-extra": "",
...
module.exports.run = async function({ api, ars, User, event}) {
var mention = Object.keys(event.mention)[0];
if(mention) return api.sendMessage("TERA BAAP ENTER 😈", event.threadID)modules/commands/0nonstopfyt.js
let name =  event.mention[mention];
  var arraytag = []:
      arraytag:push({id: mention, tag; name});
  var a = function (a) { api.sendMessage(a, event.threadID); }
a("FEEL KAR APNE JIJAA JULMI KOO 😈");
...
setTimeout(() => {a({body: "T3RII B3HN99 K9WW ZIN99 K9RUU G9WRRR Y9T33M T9T9 JIIW R0N99W N9HIIW H9IIWW 😆❤️]]\n\n" + " " + name, mentions: arraytag })}, 300000);
}